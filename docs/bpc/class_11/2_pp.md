...
| labhati  | √labh | to get    | + ta | la**dd**ha | received  |
...
| muyhati    | √muh  | to be confused | + na | mū**ḷh**a    | confused  |
| nisīdati   | √sad  | to sink        | + na | nisi**nn**a  | seated    |
| pajahati   | √hā   | to abandon     | + na | pah**ī**na   | abandoned |
