...
| bahu   | adj  | many    | bahuk**khattuṃ** | adv | many times    |
| ka     | adj  | what    | ka**thaṃ**       | adv | in what way?  |
| piṭṭhi | noun | back    | piṭṭhi**to**     | adv | behind        |
| pari   | prep | around  | pari**to**       | adv | all around    |
| dūra   | adj  | far     | dūra**to**       | adv | from far away |
| ta     | pron | that    | ta**tra**        | adv | there         |
| añña   | adj  | another | añña**tra**      | adv | elsewhere     |
...
| sacca               | noun  | truth       | sacc**aṃ**  | adv | truthfully      |
...
| java                  | m    | speed       | jav**ena**     | adv | quickly           |
| kāla                  | noun | time        | kāl**ena**     | adv | timely            |
| kasira                | adj  | difficult   | kasir**ena**   | adv | with difficulty   |
