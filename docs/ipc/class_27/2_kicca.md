...
|------|---------|--------------|-----------------|
| √gam | + tabba | ga**ntabba** | to be followed  |
| √hā  | + tabba | hā**tabba**  | to be abandoned |
| √han | + tabba | han**tabba** | to be killed    |
| √kar | + tabba | ka**ttabba** | to be done      |
| √kar | + tabba | k**ātabba**  | to be done      |
...
|-------|-----|-----------|---------|----------------|-----------------|
| √bhū  | \*e | bh**āv**e | + tabba | bhāve**tabba** | to be developed |
| √cud  | \*e | c**o**de  | + tabba | code**tabba**  | to be accused   |
| √dis  | \*e | d**e**se  | + tabba | dese**tabba**  | to be taught    |
...
|--------|----------|-----------------|-----------------------|
| √bhaṇ  | + itabba | bhaṇ**itabba**  | to be said            |
| √bhās  | + itabba | bhās**itabba**  | to be spoken          |
| √khād  | + itabba | khād**itabba**  | to be chewed          |
| √khip  | + itabba | khip**itabba**  | to be thrown          |
| √pucch | + itabba | pucch**itabba** | to be asked           |
| √sāy   | + itabba | sāy**itabba**   | to be tasted          |
...
|-------|-----|------------|----------|-----------------|--------------|
| √ñā   | nā  | jānā       | + itabba | jān**itabba**   | to be known  |
| √bhī  | a   | bh**āy**a  | + itabba | bhāy**itabba**  | to be feared |
| √dis  | a   | passa      | + itabba | pass**itabba**  | to be seen   |
...
|--------|--------|-----------------|----------------------|
| √bhuj  | + \*ya | bh**ogga**      | to be used, useable  |
| √dam   | + \*ya | da**mma**       | to be tamed, tamable |
| √garah | + \*ya | g**ā**ra**yha** | to be blamed         |
| √ghaṭ  | + \*ya | gha**cca**      | to be destroyed      |
| √has   | + \*ya | ha**ssa**       | to be laughed at     |
| √kath  | + \*ya | ka**ccha**      | to be talked to      |
| √khād  | + \*ya | kha**jjaṃ**     | to be chewed, eaten  |
| √kup   | + \*ya | ku**ppa**       | to be shaken         |
| √labh  | + \*ya | la**ddha**      | to be obtained       |
...
|--------|---------|----------------|-------------------|
| √chaḍḍ | + \*iya | chaḍḍ**iya**   | to be thrown away |
| √nind  | + \*iya | nind**iya**    | to be blamed      |
| √saṃk  | + \*iya | saṅk**iya**    | to be suspected   |
...
|------|--------|--------------|-------------------|
| √hu  | + eyya | āhun**eyya** | to be offered to  |
| √khā | + eyya | akkh**eyya** | to be said        |
| √ñā  | + eyya | viññ**eyya** | to be understood  |
| √ñā  | + eyya | n**eyya**    | to be known       |
...
<div class="nav-links">
  ...
  <div class="feedback"><a href="https://docs.google.com/forms/d/e/1FAIpQLSeCZ01pgGSYZDO7c1p7L5ciQfg1gEPIEx1g0RgPaCxSY_fQcg/viewform?usp=pp_url&entry.135905709=Intermediate+P%C4%81%E1%B8%B7i+Course+%28IPC%29&entry.2980976=ipc%2Fclass_27%2F2_kicca" target="_blank">Provide feedback on this page</a></div>
</div>
