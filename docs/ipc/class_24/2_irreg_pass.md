...
| √dhā | to hold | (ī)ya | dh**ī**ya | dhīyati[^25] | is held |
| √pā | to drink | (ī)ya | p**ī**ya | pīyati | is drunk |

[^25]: Commentary example
...
|  |  |  |  |  |  |
|---|---|---|---|---|---|
| √chid + ṃa | to cut | īya | chi**n**dīya | chindīyati[^26] | is cut |
...
[^26]: These bases (marked with \*) mostly exist in participle forms.
...
|  |  |  |  |  |  |
|---|---|---|---|---|---|
| √yaj | to sacrifice | ya | ijja | ijjati[^27] | is sacrificed |

[^27]: Not a textual example
