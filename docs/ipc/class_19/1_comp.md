...
***
2.  *digu or* **numerical** *(number + noun)*
***
e.g. catuddisā (four directions)
***
3.  *tappurisa or* **case compound** *(substantive + substantive)*
***
e.g. sāriputta (lit. son **of** Sāri)
***
4.  *dvanda or* **copulative** *(noun + noun)*
***
e.g. atītānāgatapaccuppanno (the past **and** the future **and** the present)
***
5.  *abyayībhāva or* **adverbial** *(indeclinable + substantive)*
***
e.g. yathābalaṃ (according to one’s strength)
***
6.  *bahubbīhi* or **attributive** (meaning is different from the component words)
***
e.g. rukkhamūlika (**one** **who** (lives at) the foot of a tree)
***
7.  *missaka* or **complex** (combination of one or more of the above)
***
...
<div class="nav-links">
  ...
  <div class="feedback"><a href="https://docs.google.com/forms/d/e/1FAIpQLSeCZ01pgGSYZDO7c1p7L5ciQfg1gEPIEx1g0RgPaCxSY_fQcg/viewform?usp=pp_url&entry.135905709=Intermediate+P%C4%81%E1%B8%B7i+Course+%28IPC%29&entry.2980976=ipc%2Fclass_19%2F1_comp" target="_blank">Provide feedback on this page</a></div>
</div>
